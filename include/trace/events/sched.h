...
extern unsigned long long get_task_tags(struct task_struct *task);
extern unsigned long long get_task_rsum(struct task_struct *task);
#endif
...
TRACE_EVENT(sched_switch,
	...
	TP_fast_assign(
		...
		__entry->tags = (get_task_tags(next) << 3);
		__entry->rsum = get_task_rsum(next);
#endif
	),
