...
#define MAX_CNT 14
int ufs_dsm_report_debug(struct seq_file *s, void *data)
{
	...
	switch (cnt) {
	case 0:
		seq_printf(s, "DSM_UFS_UIC_TRANS_ERR:928008003\n");
		ufs_dsm_report(hba, DSM_UFS_UIC_TRANS_ERR,
			       "UIC No Fatal Error");
		break;
	case 1:
		seq_printf(s, "DSM_UFS_UIC_CMD_ERR:928008004\n");
	...
	case 3:
		...
		ufs_dsm_report(hba, DSM_UFS_UTP_ERR, "UTP Transfer Error");
		break;
	case 4:
		seq_printf(s, "DSM_UFS_SCSI_CMD_ERR:928008009\n");
		ufs_dsm_report(hba, DSM_UFS_SCSI_CMD_ERR, "UFS SCSI Cmd Error");
		break;
	case 5:
		seq_printf(s, "DSM_UFS_LINKUP_ERR:928008011\n");
		ufs_dsm_report(hba, DSM_UFS_LINKUP_ERR, "UFS Linkup Error");
		break;
	case 6:
		seq_printf(s, "DSM_UFS_ENTER_OR_EXIT_H8_ERR:928008012\n");
		ufs_dsm_report(hba, DSM_UFS_ENTER_OR_EXIT_H8_ERR,
			       "UFS Enter/Exit H8 Fail");
		break;
	case 7:
	...
	case 8:
		...
		ufs_dsm_report(hba, DSM_UFS_DEV_INTERNEL_ERR,
			       "UFS DEV Internel Error:Sense_key = 3");
		break;
	case 9:
		seq_printf(s, "DSM_UFS_INLINE_CRYPTO_ERR:928008017\n");
		ufs_dsm_report(hba, DSM_UFS_INLINE_CRYPTO_ERR,
			       "UFS Inline Crypto Error");
		break;
	case 10:
		seq_printf(s, "DSM_UFS_HARDWARE_ERR:928008018\n");
		ufs_dsm_report(hba, DSM_UFS_HARDWARE_ERR,
			       "UFS Hardware Error:Sense_key = 4");
		break;
	case 11:
		seq_printf(s, "DSM_UFS_FFU_UPDATE_ERR:928008028\n");
		ufs_dsm_report(hba, DSM_UFS_FFU_UPDATE_ERR,
			       "UFS ffu Update Error");
		break;
	case 12:
		seq_printf(s, "DSM_UFS_DEVICE_RESET_ERR:928008029\n");
		ufs_dsm_report(hba, DSM_UFS_DEVICE_RESET_ERR,
			       "UFS Occur Device Reset and Restore");
		break;
	case 13:
		seq_printf(s, "DSM_UFS_QCOM_BER_ERR:928008030\n");
		ufs_dsm_report(hba, DSM_UFS_QCOM_BER_ERR, "UFS Qcom Ber Error");
		break;
	default:
		break;
	}
...
{
	return ufs_dsm_report_debug(s, data);
}
