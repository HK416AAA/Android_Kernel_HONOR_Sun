...
#ifdef CONFIG_HONOR_BLK_CGROUP_IOLIMIT
...
#ifdef CONFIG_HONOR_BLK_CGROUP_IOSMART
	p_oem_data1 = (struct blkg_oem_data *)&blkg->android_oem_data1;
	p_oem_data2 = (struct blkcg_oem_data *)&blkcg->android_oem_data1;
	p_oem_data1->weight = p_oem_data2->weight;
#endif
	return blkg;
...
#ifdef CONFIG_HONOR_BLK_CGROUP_IOSMART
	p_oem_data = (struct blkcg_oem_data *)&blkcg->android_oem_data1;
	p_oem_data->weight = BLKIO_WEIGHT_DEFAULT;
#endif
...
#ifdef CONFIG_HONOR_BLK_CGROUP_IOSMART
	ret = blk_iosmart_init(disk);
	if (ret)
		goto err_destroy_all;
#endif

#ifdef CONFIG_HONOR_BLK_CGROUP_IOLIMIT
	ret = blk_iolimit_init(disk);
	if (ret)
		goto err_destroy_all;
#endif
...
#ifdef CONFIG_HONOR_BLK_CGROUP_IOSMART
	blk_iosmart_exit(disk);
#endif
#ifdef CONFIG_HONOR_BLK_CGROUP_IOLIMIT
	blk_iolimit_exit(disk);
#endif
}
