...
extern int blk_iosmart_init(struct gendisk *disk);
extern void blk_iosmart_exit(struct gendisk *disk);
#else
static inline void blk_iosmart_drain_queue(struct request_queue *q) { }
static inline int blk_iosmart_init(struct gendisk *disk) { return 0; }
static inline void blk_iosmart_exit(struct gendisk *disk) { }
#endif
/*
