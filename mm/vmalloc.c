...
#ifdef CONFIG_HONOR_VMAP_ALLOC_PAGE_ON_DEMAND
...
void vfree(const void *addr)
{
	...
	trace_android_rvh_ogki_vfree_bypass(addr, &bypass);
	if (bypass)
		return;
...
#ifndef CONFIG_HONOR_VMAP_ALLOC_PAGE_ON_DEMAND
...
{
	void *addr = NULL;
	trace_android_rvh_ogki_vmalloc_node_bypass(size, gfp_mask, &addr);
	if (addr)
		return addr;
