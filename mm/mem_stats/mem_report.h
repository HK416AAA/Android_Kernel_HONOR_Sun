...
#else
static inline void mem_alloc_report(const char *device_type,
				    const char *device_name, size_t len,
...
static inline void isolated_detect(int file, unsigned long inactive,
