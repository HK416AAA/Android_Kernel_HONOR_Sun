...
{
	unsigned long ret = 0;
	trace_android_rvh_ogki_task_util(task, &ret);
	return ret;
}
...
{
	unsigned long ret = 0;
	trace_android_rvh_ogki_uclamp_task_util(task, &ret);
	return ret;
}

unsigned long long get_task_tags(struct task_struct *task)
{
	unsigned long long ret = 0;
	trace_android_rvh_ogki_get_task_tags(task, &ret);
	return ret;
}

unsigned long long get_task_rsum(struct task_struct *task)
{
	unsigned long long ret = 0;
	trace_android_rvh_ogki_get_task_rsum(task, &ret);
	return ret;
}
#endif