...
long __sys_setregid(gid_t rgid, gid_t egid)
{
	...
	trace_android_vh_ogki_audit_log_setid(4, old->gid.val, new->gid.val);
...
long __sys_setgid(gid_t gid)
{
	...
	trace_android_vh_ogki_audit_log_setid(3, old->gid.val, gid);
...
long __sys_setreuid(uid_t ruid, uid_t euid)
{
	...
	trace_android_vh_ogki_audit_log_setid(1, old->uid.val, new->uid.val);
...
long __sys_setuid(uid_t uid)
{
	...
	trace_android_vh_ogki_audit_log_setid(0, old->uid.val, uid);
...
long __sys_setresuid(uid_t ruid, uid_t euid, uid_t suid)
{
	...
	trace_android_vh_ogki_audit_log_setid(2, old->uid.val, new->uid.val);
...
long __sys_setresgid(gid_t rgid, gid_t egid, gid_t sgid)
{
	...
	trace_android_vh_ogki_audit_log_setid(5, old->gid.val, new->gid.val);
